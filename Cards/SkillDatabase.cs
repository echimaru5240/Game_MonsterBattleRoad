...
public static class SkillDatabase
{
	...
	public static readonly SkillData[] Skills = new SkillData[]
	{
        ...
        new SkillData(SkillID.SKILL_ID_NEEDLE_SHOT_1000, "針千本ショット", SkillAction.ATTACK, SkillCategory.PHYSICAL, TargetType.ENEMY_SINGLE, ElementType.NONE, 200, 0.95f, 0.1f, StatusAilmentType.NONE, 0f, StatusBuffType.NONE, 0, 0),
        ...
        new SkillData(SkillID.SKILL_ID_FIRE_BURST, "ファイアバースト", SkillAction.ATTACK, SkillCategory.MAGICAL, TargetType.ENEMY_SINGLE, ElementType.FIRE, 200, 1f, 0.1f, StatusAilmentType.NONE, 0f, StatusBuffType.NONE, 0, 0),
        new SkillData(SkillID.SKILL_ID_AQUA_SLASH, "アクアスラッシュ", SkillAction.ATTACK, SkillCategory.PHYSICAL, TargetType.ENEMY_SINGLE, ElementType.WATER, 200, 0.95f, 0.1f, StatusAilmentType.NONE, 0f, StatusBuffType.NONE, 0, 0),
